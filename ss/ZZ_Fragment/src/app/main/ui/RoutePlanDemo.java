...
public class RoutePlanDemo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedApplication app = (SharedApplication)this.getApplication();
        ...
        GeoPoint p ;
        double cLat = 29.710983 ;
        double cLon = 116.012065 ;
        ...
        Drawable drawble=super.getResources().getDrawable(R.drawable.arrow);
                MyOverLay myoverlay=new MyOverLay(drawble, this, mMapView);
               
                OverlayItem overlayitem=new OverlayItem(p, "学校", "九江学院");
      ...
      mapController.setZoom(12);
        ...
        my_pos=(Button) findViewById(R.id.my_pos);
        ...
        my_pos.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent(RoutePlanDemo.this, LocationOverlayDemo.class);
...
//					ArrayList<MKCityListInfo> enCities = res.getAddrResult().mEndCityList;
	...
	void SearchButtonProcess(View v) {
		...
		if (mBtnDrive.equals(v)) {
			mSearch.drivingSearch("九江", stNode, "九江", enNode);
		} else if (mBtnTransit.equals(v)) {
			mSearch.transitSearch("九江", stNode, enNode);
		} else if (mBtnWalk.equals(v)) {
			mSearch.walkingSearch("九江", stNode, "九江", enNode);
		} 
	}
	/**
	 * 节点浏览示例
