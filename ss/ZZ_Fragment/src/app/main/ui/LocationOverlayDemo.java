...
public class LocationOverlayDemo extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sure_callback=(Button) findViewById(R.id.button2);
      ...
      //创建 弹出泡泡图层
		...
		textItem.text = locData.latitude+"经度:"+locData.longitude;  
		...
		//修改定位数据后刷新图层生效
		mMapView.refresh();
		sure_callback.setOnClickListener(new OnClickListener(){

			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent =new Intent(LocationOverlayDemo.this,RoutePlanDemo.class);

				intent.putExtra("clat", locData.latitude);
				
				intent.putExtra("long", locData.longitude);
